        ...
        if (lvTowerList.Count > 0)
        {
            switch (level)
            {
                case 0:
                    ...
                    lvTowerList[1].transform.DOLocalMoveY(-0.0351f, timeChangeLevelTower).SetEase(Ease.OutQuad).OnComplete(() =>
                    {
                ...
                case 1:
                    ...
                    {
                        lvTowerList[1].transform.DOLocalMoveY(-0.0315f, timeChangeLevelTower).SetEase(Ease.OutQuad).OnComplete(() =>
                        {
